...
**Status:** DRAFT v1.1-clean — not deposited. Complete timestamped clean version for hard-print + 30-min cool + GATE:OPEN per `feedback_zenodo_publish_gate.md` and `feedback_submission_print_gate.md`.

**Timestamped cleanup note:** This version preserves the Z0 umbrella, source manifest, evidence thresholds, kill switches, deposit chain, and appendices from the uploaded v1.1 draft. It removes counsel-specific wording, fixes the v1.0/v1.1 mismatch, and adds explicit preregistration locks for hypotheses, baselines, metrics, data handling, and analysis timing.

| Self-reference field | Value |
|---|---|
| Version | v1.1-clean timestamped `2026-04-29T00-25-57-0700` |
...
| Timestamped cleanup note | This working draft is not canonical until committed and renamed with the resulting commit hash under the artifact-hash-naming policy. |
| Working filename | `Z0_umbrella_preregistration_v1.1_77b639c_clean_timestamped_2026-04-29T00-25-57-0700.md` |
...
- AI tools were used for drafting support, formatting, and consistency checks. They were not used as authors, data sources, evidence, proof of validity, endorsement, or co-authorship.
...
|---|---|---|---|
| **Z0** | This umbrella | Draft v1.1-clean timestamped | This document; deposit before Z1–Z3 |
...
- **v1.1-clean timestamped 2026-04-29T00-25-57-0700 (this draft):** complete cleaned version for print + cool + GATE:OPEN. Counsel-specific wording removed; hypotheses, metrics, baselines, data-handling rules, and analysis timing locks added.

## 14. Final attestation

I, Eric D. Martin, ORCID 0009-0006-5944-1742, Independent researcher, certify that:

- This pre-registration is locked at v1.1-clean final when deposited and will not be modified post-deposit. Amendments require a new Zenodo DOI.
...
## Appendix A — Cleanup audit note

This timestamped cleanup made the following bounded changes:
...
*End of Z0 umbrella pre-registration draft v1.1-clean timestamped 2026-04-29T00-25-57-0700. To be hard-printed, cooled 30 minutes, GATE:OPEN per `feedback_zenodo_publish_gate.md`, then deposited on Zenodo with DOI cross-linked back into this repository.*
