...
Planck $\Lambda$CDM), consistent with the direction of the matter density deficit
...
\citealt{Percival2007} $r_s$ approximation and our restriction to $D_M/r_s$ data
...
\begin{enumerate}
    ...
    $\Omega_m < 0.315$ consistent with $\xi$-residuals (this work),
    DESI DR1 BAO \citep{DESI_2024_DR1}, DESI DR2 \citep{DESI_2025_DR2}, and
    $S_8/\sigma_8$ weak lensing \citep{Heymans2021, Amon2022}.
\end{enumerate}

A $w_0w_a$ dark energy layer is not supported by the current data
($\Delta\chi^2 = 0.12$ for two additional parameters). The dark energy question
remains open and requires Euclid DR1 to resolve (see Section~\ref{sec:limitations}
and the Methods footnote on $r_s$ self-consistency).
...
$r_s(\Omega_m)$ scaling from \citealt{Percival2007} is an approximation; a more
...
by horizon-normalization. The residual is a matter density deficit consistent with
DESI BAO, weak lensing surveys, and the $\xi$-normalized
